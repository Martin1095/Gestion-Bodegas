package com.gestion.cliente.assemblers;
...
import com.gestion.cliente.controller.ClienteController;
...
public class ClienteModelAssembler implements RepresentationModelAssembler<ClienteDTO, EntityModel<ClienteDTO>> {
    ...
    public EntityModel<ClienteDTO> toModel(ClienteDTO cliente) {
        return EntityModel.of(cliente,
                linkTo(methodOn(ClienteController.class).obtenerClientePorId(cliente.getId_cliente())).withSelfRel(),
